...
##################################
##################################
for number_smaples in [10, 30]:  # How many sub-boxes
                ...
                for sim in ['Mn_0d6_nu_pcls','lcdm']:
                    ...
                    for ngrid in [2, 20]:
                        ...
                        for i in range(number_smaples):
                            ...
                            print("before print: ",str(number_smaples));
                            with open('./save_data/data_ngrid_'+str(ngrid)+'_sim_'+sim+'_Nsubboxes_'+str(number_smaples)+'.pickle', 'wb') as handle:
