...
print({'simulation': simulation, 'boxsize': boxsize, 'ngrid': ngrid, 'ngrid_min': ngrid_min, 'ngrid_max': ngrid_max, 'ngrid_step': ngrid_step, 'mass cut = ':"{:.4e}".format(mass_limit)
